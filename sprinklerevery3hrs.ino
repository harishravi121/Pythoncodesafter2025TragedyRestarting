loop{
  ...
  pin2= 1 ( switch on relay to solenoid valve for 200 re with 20 re relay and 2 re transistor with )
...
With direct transistor and solenoid it will be residential code but with a relay its 220 V motro for 1 km squared farm
